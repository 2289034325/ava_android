 ...
 */
public class SaveBookMark extends UseCase<Void, BookMark> {

  private final ReadingService readingService;

  @Inject
  SaveBookMark(ThreadExecutor threadExecutor,
               PostExecutionThread postExecutionThread, ReadingService readingService) {
    super(threadExecutor, postExecutionThread);
    this.readingService = readingService;
  }

  @Override Observable buildUseCaseObservable(BookMark bookMark) {
    return this.readingService.saveBookMark(bookMark);
  }
}
